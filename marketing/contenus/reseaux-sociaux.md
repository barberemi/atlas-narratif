...
## Banque de posts X (à programmer, 3-5/sem)
...
> Ton tome 2 part en vrille ? 90 % du temps, c'est pas ton écriture. C'est que tu tiens 40 fils narratifs *dans ta tête*.
> Mets-les sous tes yeux. 👇 [GIF de la timeline]
> #ProjetÉcriture

### Feature émotionnelle (avec capture détection)
> « L'amorce du chapitre 3 attend son paiement au tome 2. »
> Ça, c'est ton cerveau qui ne peut pas suivre. Et ça, c'est Atlas qui te le rappelle 👇 [capture]

### Anti-IA (positionnement identitaire)
> Non, Atlas n'écrit pas ton roman à ta place.
> Pas une ligne. Pas un mot.
> Il t'aide à *voir* ton histoire et à *l'organiser*. Le reste, c'est ta plume. Point.
> #écriture
...
## Thread de lancement X (S7)

**Tweet 1 (hook)**
> Depuis des mois, je code en secret l'outil dont je rêvais en tant qu'auteur.
> Aujourd'hui je le lance. 🎉
> **Atlas Narratif** : structure ton roman, visualise ta saga, traque les incohérences. Gratuit, français.
> Thread 🧵👇

**Tweet 2**
> Le problème que je voulais régler : écrire un roman long, c'est tenir des centaines de fils à la fois. Dans sa tête. Jusqu'à ce que ça craque.
> Un perso qui change de couleur d'yeux entre deux tomes. Un fil oublié. Une intrigue sans colonne vertébrale.

**Tweet 3**
> La solution en 3 temps 👇
> 1️⃣ Tu poses ta structure avec une vraie méthode : Save the Cat ou le Voyage du Héros. Chaque beat expliqué, illustré par des œuvres connues.

**Tweet 4**
> 2️⃣ Tu vois ton histoire *en entier* : timeline, carte des lieux, graphe de relations, arc émotionnel. La même histoire sous tous les angles. [GIF]

**Tweet 5**
> 3️⃣ Tu repères les failles avant tes lecteurs : +12 détecteurs d'incohérences, et un tracker d'amorces/paiements qui suit tes promesses d'un tome à l'autre. [capture]

**Tweet 6 (anti-IA)**
> Ce qu'Atlas ne fait PAS : écrire à ta place. Zéro texte généré. L'outil structure, c'est toi qui crées.
> Tes contenus t'appartiennent, tout est chiffré, aucun tracking.
...
- **Screenshot annoté** de la carte LOTR (« chaque trait = le trajet d'un perso »).
- **Story** build-in-public : « aujourd'hui je code la fonctionnalité X, vous en pensez quoi ? »
