...
export default function ObjectCard({ obj, highlighted, flash, onCharacterClick, onRelations }) {
  ...
  return (
    <DarkCard ref={ref} color={ENTITY_COLORS.object} accent={ENTITY_COLORS.object} highlighted={highlighted} flash={flashing}>
